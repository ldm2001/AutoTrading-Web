<script lang="ts">
	...
	import StockTable from '$lib/components/panels/stock/StockTable.svelte';
	import StockChart from '$lib/components/panels/stock/StockChart.svelte';
	import IndexPanel from '$lib/components/panels/market/IndexPanel.svelte';
	import TradeConsole from '$lib/components/panels/trade/TradeConsole.svelte';
	import OrderPanel from '$lib/components/panels/trade/OrderPanel.svelte';
	import AISignalPanel from '$lib/components/panels/ai/AISignalPanel.svelte';
	import NewsPanel from '$lib/components/panels/ai/NewsPanel.svelte';
	import DailyReport from '$lib/components/panels/ai/DailyReport.svelte';
	import PredictPanel from '$lib/components/panels/ai/PredictPanel.svelte';
	import BacktestPanel from '$lib/components/panels/backtest/BacktestPanel.svelte';
	import SectorHeatmap from '$lib/components/panels/market/SectorHeatmap.svelte';
	import HoldingsPanel from '$lib/components/panels/portfolio/HoldingsPanel.svelte';
	import TradeHistoryPanel from '$lib/components/panels/portfolio/TradeHistoryPanel.svelte';
	import ProfitPanel from '$lib/components/panels/portfolio/ProfitPanel.svelte';
	import VolatilityPanel from '$lib/components/panels/market/VolatilityPanel.svelte';
	import SectorFlowPanel from '$lib/components/panels/market/SectorFlowPanel.svelte';
